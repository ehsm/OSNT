...
////////////////////////////  Includes & Defines //////////////////////////////
	 ...
	 module ETH_IPv4_GRE_PPP_IPv4_TCPnUDP
   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if;
	 		...
	 		begin		
	 			...
	 			begin
	 				...
	 				begin
		 				...
		 				begin
		 					pkt_gre_hdr_len_w = 4'b0;
	 						pkt_flags_w[`PKT_FLG_PPP] = (in_data_d0[95:80] == `GRE_PPP && (in_data_d0[79:72] == `PPP_ADDR) && (in_data_d0[71:64] == `PPP_CTRL));
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_ETH_IPv4_GRE_PPP_IPv4_TCPnUDP;           
