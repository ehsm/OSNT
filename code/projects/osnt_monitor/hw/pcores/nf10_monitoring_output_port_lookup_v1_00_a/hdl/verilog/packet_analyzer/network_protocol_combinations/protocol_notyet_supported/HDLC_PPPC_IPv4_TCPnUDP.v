...
////////////////////////////  Includes & Defines //////////////////////////////
   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if;
	 ...
	 begin  
	 		...
	 		begin		 	
	 			...
	 			begin
		 			...
		 			begin
		 				pkt_flags_w[`PKT_FLG_IPv4] = (in_data_d0[119:112] == `PPPC_IP);
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_HDLC_PPPC_IPv4_TCPnUDP;           
