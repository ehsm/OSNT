...
////////////////////////////  Includes & Defines //////////////////////////////
	 ...
	 module ETH_MPLS_MPLS_ETH_IPv4_TCPnUDP 
   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if;	 
	 ...
	 begin  
	 		...
	 		begin		 	
	 			if (in_wr_d0)
	 			begin
		 			pkt_flags_w[`PKT_FLG_IPv4] = (in_data_d0[111:96] == `ETH_IP);
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_ETH_MPLS_MPLS_ETH_IPv4_TCPnUDP;           
