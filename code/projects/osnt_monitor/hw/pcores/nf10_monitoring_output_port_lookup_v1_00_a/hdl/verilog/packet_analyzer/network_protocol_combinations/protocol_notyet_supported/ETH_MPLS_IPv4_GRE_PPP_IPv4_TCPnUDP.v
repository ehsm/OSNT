...
////////////////////////////  Includes & Defines //////////////////////////////
	 ...
	 module ETH_MPLS_IPv4_GRE_PPP_IPv4_TCPnUDP 
 ...
 always @ (posedge clk or posedge reset)
	 ...
	 begin  
			...
			pkt_ip_hdr_len_w_0 = pkt_ip_hdr_len_0;
	 		...
	 		begin		
	 			if (in_wr_d0)
	 			begin
	 				if (in_data_d0[120] == 1'b1)/*MPLS bottom of label stack bit*/
	 				begin
						pkt_flags_w[`PKT_FLG_IPv4] = ( (in_data_d0[111:108] == `IP_VER4)/*Version = 4*/ 
		 															 &&(in_data_d0[107:104]	== 	4'd5)/*Header Length = 5*/);	
		 				if(pkt_flags_w[`PKT_FLG_IPv4])
		 				begin
		 					pkt_ip_hdr_len_w_0 = in_data_d0[107:104];
				 			pkt_flags_w[`PKT_FLG_FRG] = (in_data_d0[61] || (in_data_d0[60:48] != 14'd0)); /* @ shahbaz - resolve */
			 				if (!pkt_flags_w[`PKT_FLG_FRG])
			 				begin	 					
					 			pkt_flags_w[`PKT_FLG_GRE] = (in_data_d0[39:32] == `IP_GRE);
	 		...
	 		begin		
	 			...
	 			begin
	 				...
	 				4'd5:
	 				begin
	 					case(in_data_d0[79:76])
		 				4'b0000: //{checksum = 0, routing = 0, key = 0, sequence no = 0}						
		 				begin
		 					pkt_gre_hdr_len_w = 4'b0;
	 						pkt_flags_w[`PKT_FLG_PPP] =( (in_data_d0[63:48] == `GRE_PPP) && (in_data_d0[47:40] == `PPP_ADDR) && (in_data_d0[39:32] == `PPP_CTRL) );
	 						if(pkt_flags_w[`PKT_FLG_PPP])
	 						begin				
	 							pkt_flags_w[`PKT_FLG_IPv4] = (in_data_d0[31:16] == `PPP_IP);
	 							if(pkt_flags_w[`PKT_FLG_IPv4])
	 							begin
	 								pkt_ip_hdr_len_w_1 = in_data_d0[11:8];
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_ETH_MPLS_IPv4_GRE_PPP_IPv4_TCPnUDP;           
