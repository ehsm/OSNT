...
////////////////////////////  Includes & Defines //////////////////////////////
	 ...
	 module ETH_MPLS_ETH_IPv4_TCPnUDP 
   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if;	 
	 ...
	 begin  
	 		...
	 		begin		
	 			...
	 			begin
	 				...
	 				begin
		 				pkt_flags_w[`PKT_FLG_IPv4] = (in_data_d0[15:0] == `ETH_IP);
	 		...
	 		begin		 	
	 			if (in_wr_d0)
	 			begin
	 				pkt_ip_hdr_len_w = in_data_d0[123:120]; // in 32 bit words
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_ETH_MPLS_ETH_IPv4_TCPnUDP;           
