   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if;
	 ...
	 begin  
	 		...
	 		begin		
	 			...
	 			begin
	 				...
	 				begin
		 				...
		 				begin
			 				pkt_ip_hdr_len_w = in_data_d0[107:104]; // in 32 bit words
				 			...
				 			pkt_src_ip_w = {in_data_d0[15:0], pkt_src_ip[15:0]};
	 		...
	 		begin		 	
	 			if (in_wr_d0)
	 			begin
		 			pkt_src_ip_w = {pkt_src_ip[31:16], in_data_d0[127:112]};
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_ETH_MPLS_IPv4_TCPnUDP;           
