   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if; 
	 ...
	 begin  
	 		...
	 		begin		 	
	 			if (in_wr_d0)
	 			begin
	 				pkt_flags_w[`PKT_FLG_HDLC] = (in_data_d0[127:120] == `HDLC_FLAG);		 			
		 			if (pkt_flags_w[`PKT_FLG_HDLC])
		 			begin
			 			pkt_flags_w[`PKT_FLG_PPP] = (in_data_d0[119:112] == `PPP_ADDR) && (in_data_d0[111:104] == `PPP_CTRL);	
			 			if (pkt_flags_w[`PKT_FLG_PPP])
			 			begin
			 				pkt_flags_w[`PKT_FLG_IPv4] = (in_data_d0[103:88] == `PPP_IP);
							if (pkt_flags_w[`PKT_FLG_IPv4])
					 		begin
					 			pkt_ip_hdr_len_w = in_data_d0[83:80]; // in 32 bit words
					 			pkt_flags_w[`PKT_FLG_FRG] = (in_data_d0[37] || (in_data_d0[36:24] != 14'd0));
						 		pkt_flags_w[`PKT_FLG_TCP] = (in_data_d0[15:8] == `IP_TCP);
						 		pkt_flags_w[`PKT_FLG_UDP] = (in_data_d0[15:8] == `IP_UDP);
	 		...
	 		begin		
	 			if (in_wr_d0)
	 			begin
	 				pkt_src_ip_w = in_data_d0[119:88];
 					pkt_dst_ip_w = in_data_d0[87:56];
		 			...
		 			begin	
			 			...
			 			begin	
			 				...
			 				4'd5:
			 				begin
			 					pkt_src_port_w = in_data_d0[55:40];
			 					pkt_dst_port_w = in_data_d0[39:24];
	 		...
	 		begin		
	 			...
	 			begin
			 		...
			 		begin
			 			pkt_flags_w[`PKT_FLG_RTP] = (in_data_d0[119:116] == `UDP_RTP);
			 			nxt_state = PKT_WAIT_HDR;
			 		end
 					else if (pkt_flags[`PKT_FLG_TCP])
					begin
						pkt_tcp_hdr_len_w = in_data_d0[87:84]; // in 32 bit words
	 					case(pkt_tcp_hdr_len_w)
				 		4'd5:
				 		begin	 
				 			pkt_flags_w[`PKT_FLG_GET] = (in_data_d0[23:0] == `TCP_GET);
			 				pkt_flags_w[`PKT_FLG_POST] = (in_data_d0[23:0] == `TCP_POS);
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_HDLC_PPP_IPv4_TCPnUDP;           
