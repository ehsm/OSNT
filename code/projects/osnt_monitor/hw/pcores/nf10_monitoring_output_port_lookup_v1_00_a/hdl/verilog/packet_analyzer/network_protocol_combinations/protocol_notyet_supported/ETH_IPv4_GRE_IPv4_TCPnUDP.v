...
////////////////////////////  Includes & Defines //////////////////////////////
	 ...
	 module ETH_IPv4_GRE_IPv4_TCPnUDP 
   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if;
	 ...
	 begin  
	 		...
	 		begin		
	 			...
	 			begin
	 				...
	 				4'd5:
	 				begin
	 					pkt_flags_w[`PKT_FLG_IPv4] = (in_data_d0[95:80] == `GRE_IP);
	 					if(pkt_flags_w[`PKT_FLG_IPv4])
	 					begin	
		 					case(in_data_d0[111:108])
		 					4'b0000: //{checksum = 0, routing = 0, key = 0, sequence no = 0}						
		 					begin
		 						pkt_gre_hdr_len_w = 4'b0; // Shahbaz - Discuss ...
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_ETH_IPv4_GRE_IPv4_TCPnUDP;           
