...
////////////////////////////  Includes & Defines //////////////////////////////
	 ...
	 module ETH_IPv4_UDP_L2TP_IPv4_TCPnUDP 
   (// --- Interface to the previous stage
    ...
    input                                  clk 
	 ...
	 localparam IDLE			 										= 4'd0,
	 						...
	 						PKT_WORD3_withNO_OFFSET			  = 4'd7,
	 						PKT_WORD4_withNO_OFFSET				= 4'd8,
	 						PKT_WORD5_withNO_OFFSET				= 4'd9,
	 						PKT_WAIT_HDR  								= 4'd10,
	 						PKT_WAIT_EOP  								= 4'd11;
   ...
   reg [`NUM_INPUT_QUEUES-1:0] 	pkt_input_if;
	 ...
	 begin  
	 		...
	 		begin		 	
	 			...
	 			begin
		 			...
		 			4'd5:
		 			begin
		 				pkt_flags_w[`PKT_FLG_IPv4] =1'b1;
	 					if(pkt_flags_w[`PKT_FLG_IPv4])
	 					begin
	 						pkt_ip_hdr_len_w_1 = in_data_d0[107:104];
	 		...
	 		begin		 	
	 			...
	 			begin
		 			...
		 			begin
	 					...
	 					if(pkt_flags_w[`PKT_FLG_IPv4])
	 					begin
	 						pkt_ip_hdr_len_w_1 = in_data_d0[123:120];
	 ...
	 assign pkt_attributes[(`PRTCL_ID_WIDTH+`PRTCL_ID_OFFSET)-1:`PRTCL_ID_OFFSET] = `PRIORITY_ETH_IPv4_UDP_L2TP_IPv4_TCPnUDP;           
