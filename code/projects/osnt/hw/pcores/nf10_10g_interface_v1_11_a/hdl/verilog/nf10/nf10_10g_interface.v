...
(
  ...
  wire		pkt_start;
    ...
    // Master Stream Ports (before timestamp insertion)
    wire [C_M_AXIS_DATA_WIDTH - 1:0]s_axis_tdata_time;
    wire [((C_M_AXIS_DATA_WIDTH / 8)) - 1:0] s_axis_tstrb_time;
    wire [C_M_AXIS_TUSER_WIDTH-1:0] s_axis_tuser_time;
    wire s_axis_tvalid_time;
    wire s_axis_tready_time;
    wire s_axis_tlast_time;
  ...
  (
   ...
   xgmac xgmac
    ...
    ////////////////////////////////
    // Instantiate the Timestamp-Insertion module
    ////////////////////////////////
    timestamp_insertion
