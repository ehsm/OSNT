...
// (2) Add supprot for cross-clock registers. At the moment, all are running at the core_clk and not on SRAM clock.
//     This won't hurt for now as all are levelled signals i.e., one time configured by the software.
